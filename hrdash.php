...
<head>
    ...
    <!-- view Styles -->
    <script src="public/css/view/hrdash.css"></script>
...
<body>
    ...
    <div id="remin">
                            ...
                            <div class="col  m6 s6">
                                <div class="card " style="background: #28C76F;">
                                    <div class="card-content white-text">
                                        ...
                                        <br> PRFs to be Initiated :
                                        <?php echo $countInitiate; ?>
                                    </div>
                            ...
                            <div class="col  m6 s6">
                                <div class="card " style="background: #9F44D3;">
                                    <div class="card-content white-text">
                                        ...
                                        <br> Total Ongoing PRFs :
                                        <?php echo $countOngoing; ?>
                                        <p></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col  m6 s6">
                                <div class="card " style="background: #28C76F; ">
                                    <div class="card-content white-text">
                                        ...
                                        <br> Interviews to be Resheduled :
                                        <?php echo $countSchedule; ?>
                                        <p></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col  m6 s6">
                                <div class="card " style="background: #677E8C">
                                    <div class="card-content white-text">
                                        ...
                                        <br> Total Scheduled Interviews :
                                        <?php echo $countInterviews; ?>
                                        <p></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col  m6 s6">
                                <div class="card " style="background: #EA5455; ">
                                    <div class="card-content white-text">
                                        ...
                                        <br> Offer Letter Requests :
                                        <?php echo $countOffers; ?>
                                        <p></p>
                                        <!-- </div> -->
                                    </div>
                                </div>
        ...
        <!-- view Scripts -->
        <script src="public/js/view/hrdash.js"></script>
</body>
